...
//create the method  to save user
  ...
  Future<http.Response> saveUser(LoginModel model) async {
    //creare URI

    var uri = Uri.parse("http://localhost:3000/api/login");
    ...
    Map data = {'username': model.getUsername, 'password': '$encryptedText'};
